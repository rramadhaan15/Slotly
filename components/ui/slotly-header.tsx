...
export function SlotlyHeader() {
  ...
  return (
    <header
      className={cn(
        'sticky top-0 z-50 mx-auto w-full border-b border-transparent bg-[#fbfcfa]/95 transition-all duration-300 ease-out',
        scrolled &&
          !open &&
          'top-3 max-w-[1160px] rounded-2xl border-[#dce7df] bg-[#fbfcfa]/88 shadow-[0_14px_38px_rgba(23,50,38,0.1)] backdrop-blur-xl',
        open && 'bg-[#fbfcfa]',
      )}
    >
      <nav
        className={cn(
          'mx-auto flex h-[78px] w-full max-w-[1500px] items-center justify-between px-7 transition-all duration-300 ease-out sm:px-10',
